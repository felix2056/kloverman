...
<?php require_once('../products/db/cups-straws_cat.php'); ?>


<?php
    $products = json_decode(getAllCupsNStraws(), true);
?>
    ...
    <div class="container">
        <div id="shopify-section-collection-template" class="shopify-section collection-template-section">
            <div class="sixteen columns clearfix collection_nav">
                <h1 class="collection_title "><a href="/collections/cups-straws.php"
                        title="Cups & Straws">Cups & Straws</a></h1>
            ...
            <div class="sixteen columns">
                <div class="section clearfix">
                    <div style="text-align: center;"><img src="/assets/images/cups_2048x2048.jpg" alt="" style="float: none;"></div>
                </div>
            </div>
