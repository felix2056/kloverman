...
<?php require_once('../products/db/apertizer-minis_cat.php'); ?>


<?php
    $products = json_decode(getAllApeizerMinis(), true);
?>
    ...
    <div class="container">
        <div id="shopify-section-collection-template" class="shopify-section collection-template-section">
            <div class="sixteen columns clearfix collection_nav">
                <h1 class="collection_title "><a href="/collections/appetizer-minis.php"
                        title="Appetizers &amp; Minis">Appetizers &amp; Minis</a></h1>
            ...
            <div class="sixteen columns">
                <div class="section clearfix">
                    <div style="text-align: center;"><img src="/assets/images/appetizers_2048x2048" alt="" style="float: none;"></div>
                </div>
            </div>
