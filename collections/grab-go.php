...
<?php require_once('../products/db/grab-go_cat.php'); ?>


<?php
    $products = json_decode(getAllGrabNGo(), true);
?>
    ...
    <div class="container">
        <div id="shopify-section-collection-template" class="shopify-section collection-template-section">
            <div class="sixteen columns clearfix collection_nav">
                <h1 class="collection_title "><a href="/collections/grab-go.php"
                        title="Grab & Go">Grab & Go</a></h1>
            ...
            <div class="sixteen columns">
                <div class="section clearfix">
                    <div style="text-align: center;"><img src="/assets/images/grab_go_8c8154b2-366c-40f8-b42b-3291fbae8a96_2048x2048.jpg" alt="" style="float: none;"></div>
                </div>
            </div>
