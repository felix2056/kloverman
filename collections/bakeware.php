...
<?php require_once('../products/db/bakeware_cat.php'); ?>


<?php
    $products = json_decode(getAllBakeware(), true);
?>
    ...
    <div class="container">
        <div id="shopify-section-collection-template" class="shopify-section collection-template-section">
            <div class="sixteen columns clearfix collection_nav">
                <h1 class="collection_title "><a href="/collections/bakeware.php"
                        title="Bakeware">Bakeware</a></h1>
            ...
            <div class="sixteen columns">
                <div class="section clearfix">
                    <div style="text-align: center;"><img src="/assets/images/bakeware_653e88a2-3c39-4a50-9385-6d3e00635ce9_2048x2048.jpg" alt="" style="float: none;"></div>
                </div>
            </div>
