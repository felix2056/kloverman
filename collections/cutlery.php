...
<?php require_once('../products/db/cutlery_cat.php'); ?>


<?php
    $products = json_decode(getAllCutlery(), true);
?>
    ...
    <div class="container">
        <div id="shopify-section-collection-template" class="shopify-section collection-template-section">
            <div class="sixteen columns clearfix collection_nav">
                <h1 class="collection_title "><a href="/collections/cutlery.php"
                        title="Cutlery">Cutlery</a></h1>
            ...
            <div class="sixteen columns">
                <div class="section clearfix">
                    <div style="text-align: center;"><img src="/assets/images/cutlery_2f90fc0e-de0f-40a3-9062-6c10e3103fd3_2048x2048.jpg" alt="" style="float: none;"></div>
                </div>
            </div>
